...
import './lib/hex-util';
import {hexCharCodeToStr, strToHexCharCode} from "./lib/hex-util";
...
function Encry(props) {
    let str = 'SZ12345,SZ002122';
    str = strToHexCharCode(str);
    // str = hexCharCodeToStr(str);
    return (
        <div>
            <span>{str}</span>
        </div>
